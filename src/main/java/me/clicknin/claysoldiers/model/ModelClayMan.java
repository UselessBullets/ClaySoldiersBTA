...
public class ModelClayMan extends ModelBiped {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if(this.isClimbing) {
            ...
            this.bipedHeadwear.rotateAngleX -= 0.6F;
